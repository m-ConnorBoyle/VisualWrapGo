    ...
    for (let i = 0; i < passes; i++) {
      ...
      if (itemType === "cross")
        generateCrossObject(
          xCoord,
          yCoord,
          colours[Number(color1) - 1],
          colours[Number(color2) - 1],
          -45,
          current_line_width,
        );
      else if (itemType === "threadDown")
        generateThreadObject(
          xCoord,
          yCoord,
          colours[Number(color1) - 1],
          -45,
...
<template>
  <header
    class="sticky top-0 z-10 flex h-[57px] items-center bg-stone-800 gap-1 border-b px-4"
  >
  ...
  <div class="grid h-[90vh] w-full pl-[110px]">
    ...
    <div class="flex flex-col justify-center items-center">
      ...
      >
        <div
          class="relative flex h-full min-h-[20vh] items-center flex-col p-4 lg:col-span-2"
          id="mainContainer"
        >
          ...
          <div class="relative flex gap-1 mb-6 mt-6">
            <div v-for="(c, i) in colours" class="columns-1">
              <div
                :class="`bg-${c} w-8 h-8 hover:border-2`"
          ...
          <div class="font-untitledSans">
            Cross X 100 Y 100 Spool_Up 4 Spool_Dn 1 Right plus 0 init# 20 passes
            3 % 1.1 !descriptive comment
          </div>
          <div class="flex-1" />
        </div>
      </main>
