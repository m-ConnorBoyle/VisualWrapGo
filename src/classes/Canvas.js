...
class Canvas {
    ...
    onPointerMove() {
        this._app.view.addEventListener('pointermove', (e) => {
            ...
            requestAnimationFrame(() => {
                ...
                this.drawDottedLine(this._hoverLines[3], { x: mouseX, y: mouseY - this._width }, -Math.PI / 4, 800, 0x000000, 2, [3, 3])
                this.drawDottedLine(this._hoverLines[4], { x: mouseX + myOffset, y: mouseY + myOffset }, -Math.PI / 4, 800, 0x000000, 2, [3, 3])
                this.drawDottedLine(this._hoverLines[5], { x: mouseX - myOffset, y: mouseY + myOffset }, Math.PI / 4, 800, 0x000000, 2, [3, 3])
    ...
    drawDottedLine(graphics, start, angle, distance, color, lineWidth, dashArray) {
    ...
    hoverLines() {
        ...
        this._hoverLines = [hoverLine1, hoverLine2, hoverLine3, hoverLine4, hoverLine5, hoverLine6]
